...
namespace Ajuna.SDK.Demos.NetApi.Generated.Storage
{
    ...
    public sealed class NominationPoolsStorage
    {
        ...
        public NominationPoolsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "PoolMembers"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.PoolMember)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "BondedPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "RewardPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.RewardPool)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "SubPoolsStorage"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.SubPools)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "Metadata"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT43)));
        ...
        ///  Active members.
        /// </summary>
        public static string PoolMembersParams(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Active members.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.PoolMember> PoolMembers(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.PoolMembersParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.PoolMember>(parameters, token);
        }
        ...
        ///  Storage for bonded pools.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner> BondedPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.BondedPoolsParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.BondedPoolInner>(parameters, token);
        }
        ...
        ///  is claimed, the balance comes out fo the reward pool. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.RewardPool> RewardPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.RewardPoolsParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.RewardPool>(parameters, token);
        }
        ...
        ///  hence the name sub-pools. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.SubPools> SubPoolsStorage(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.SubPoolsStorageParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.SubPools>(parameters, token);
        }
        ...
        ///  Metadata for the pool.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT43> Metadata(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.MetadataParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT43>(parameters, token);
        }
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  accounts are deterministically derived from it.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> ReversePoolIdLookup(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
    ...
    public sealed class NominationPoolsCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method BondExtra(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumBondExtra extra)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Unbond(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 member_account, Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> unbonding_points)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method WithdrawUnbonded(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 member_account, Ajuna.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(member_account.Encode());
            byteArray.AddRange(num_slashing_spans.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Create(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> amount, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 root, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 nominator, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 state_toggler)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Nominate(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32> validators)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetState(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumPoolState state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetConfigs(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_join_bond, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp min_create_bond, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_pools, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members_per_pool)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdateRoles(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_root, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_nominator, Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_nomination_pools.EnumConfigOp new_state_toggler)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
