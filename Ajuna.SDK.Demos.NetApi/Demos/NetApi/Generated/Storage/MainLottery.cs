...
namespace Ajuna.SDK.Demos.NetApi.Generated.Storage
{
    ...
    public sealed class LotteryStorage
    {
        ...
        public LotteryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Lottery", "Lottery"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Lottery", "Participants"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Lottery", "Tickets"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Lottery", "CallIndices"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31)));
        }
        ...
        ///  The configuration for the current lottery.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig> Lottery(CancellationToken token)
        {
            string parameters = LotteryStorage.LotteryParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig>(parameters, token);
        }
        ...
        /// </summary>
        public static string ParticipantsParams(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Users who have purchased a ticket. (Lottery Index, Tickets Purchased)
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>> Participants(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = LotteryStorage.ParticipantsParams(key);
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>>(parameters, token);
        }
        ...
        ///  are actually valid ticket mappings.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32> Tickets(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
        ...
        ///  by `Config::ValidateCall`.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> CallIndices(CancellationToken token)
        {
            string parameters = LotteryStorage.CallIndicesParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>(parameters, token);
        }
    }
    ...
    public sealed class LotteryCalls
    {
        ...
        /// </summary>
        public static Method BuyTicket(Ajuna.SDK.Demos.NetApi.Generated.Model.node_runtime.EnumCall call)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetCalls(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.node_runtime.EnumCall> calls)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
