...
namespace Ajuna.SDK.Demos.NetApi.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Account"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.AccountInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.weights.PerDispatchClassT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockHash"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ParentHash"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Digest"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.generic.digest.Digest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Events"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EventRecord>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "EventTopics"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256), typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32>>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "LastRuntimeUpgrade"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.LastRuntimeUpgradeInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ExecutionPhase"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EnumPhase)));
        }
        ...
        /// </summary>
        public static string AccountParams(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.AccountInfo> Account(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.AccountInfo>(parameters, token);
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.weights.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.weights.PerDispatchClassT1>(parameters, token);
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> BlockHash(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> ParentHash(CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.generic.digest.Digest> Digest(CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, token);
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EventRecord>> Events(CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EventRecord>>(parameters, token);
        }
        ...
        /// </summary>
        public static string EventTopicsParams(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32>>> EventTopics(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, token);
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_system.EnumPhase>(parameters, token);
        }
    }
    ...
    public sealed class SystemCalls
    {
        ...
        /// </summary>
        public static Method FillBlock(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill ratio)
        {
