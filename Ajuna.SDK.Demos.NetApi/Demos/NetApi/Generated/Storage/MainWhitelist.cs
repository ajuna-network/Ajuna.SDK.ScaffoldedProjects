...
namespace Ajuna.SDK.Demos.NetApi.Generated.Storage
{
    ...
    public sealed class WhitelistStorage
    {
        ...
        public WhitelistStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Whitelist", "WhitelistedCall"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256), typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple)));
        }
        
        /// <summary>
        /// >> WhitelistedCallParams
        /// </summary>
        public static string WhitelistedCallParams(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// >> WhitelistedCall
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseTuple> WhitelistedCall(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
    ...
    public sealed class WhitelistCalls
    {
        ...
        /// </summary>
        public static Method WhitelistCall(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 call_hash)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RemoveWhitelistedCall(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method DispatchWhitelistedCall(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 call_hash, Ajuna.NetApi.Model.Types.Primitive.U64 call_weight_witness)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method DispatchWhitelistedCallWithPreimage(Ajuna.SDK.Demos.NetApi.Generated.Model.node_runtime.EnumCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
