...
namespace Ajuna.SDK.Demos.NetApi.Generated.Storage
{
    ...
    public sealed class BagsListStorage
    {
        ...
        public BagsListStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BagsList", "ListNodes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BagsList", "ListBags"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag)));
        }
        ...
        /// </summary>
        public static string ListNodesParams(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node> ListNodes(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = BagsListStorage.ListNodesParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node>(parameters, token);
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag> ListBags(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = BagsListStorage.ListBagsParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag>(parameters, token);
        }
    }
    ...
    public sealed class BagsListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 dislocated)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PutInFrontOf(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
