...
namespace Ajuna.SDK.Demos.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IElectionsControllerMockupClient
   {
      ...
      Task<bool> SetCandidates(BaseVec<BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32, U128>> value);
      Task<bool> SetElectionRounds(U32 value);
      Task<bool> SetVoting(Voter value, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
   }
}
