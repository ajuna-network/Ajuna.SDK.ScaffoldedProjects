...
namespace Ajuna.SDK.Demos.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class CouncilControllerMockupClient : MockupBaseClient, ICouncilControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Council/Proposals", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.ProposalsParams());
      }
      public async Task<bool> SetProposalOf(EnumCall value, Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Council/ProposalOf", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<bool> SetVoting(Votes value, Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Council/Voting", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.VotingParams(key));
      }
      public async Task<bool> SetProposalCount(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Council/ProposalCount", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.ProposalCountParams());
      }
      public async Task<bool> SetMembers(BaseVec<AccountId32> value)
      {
         return await SendMockupRequestAsync(_httpClient, "Council/Members", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.MembersParams());
      }
      public async Task<bool> SetPrime(AccountId32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Council/Prime", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.CouncilStorage.PrimeParams());
      }
   }
}
