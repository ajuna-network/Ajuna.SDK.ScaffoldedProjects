...
namespace Ajuna.SDK.Demos.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraControllerMockupClient : MockupBaseClient, IAuraControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/Authorities", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Model.PalletAura.AuraStorage.AuthoritiesParams());
      }
      public async Task<bool> SetCurrentSlot(Slot value)
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/CurrentSlot", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Model.PalletAura.AuraStorage.CurrentSlotParams());
      }
   }
}
