...
namespace Ajuna.SDK.Demos.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class BalancesControllerMockupClient : MockupBaseClient, IBalancesControllerMockupClient
   {
      ...
      public async Task<bool> SetAccount(AccountData value, Ajuna.SDK.Demos.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Balances/Account", value.Encode(), BalancesStorage.AccountParams(key));
      }
      public async Task<bool> SetLocks(WeakBoundedVecT3 value, Ajuna.SDK.Demos.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Balances/Locks", value.Encode(), BalancesStorage.LocksParams(key));
      }
      public async Task<bool> SetReserves(BoundedVecT3 value, Ajuna.SDK.Demos.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
