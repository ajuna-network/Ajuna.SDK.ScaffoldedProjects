...
namespace Ajuna.SDK.Demos.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class MmrControllerMockupClient : MockupBaseClient, IMmrControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Mmr/RootHash", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.MmrStorage.RootHashParams());
      }
      public async Task<bool> SetNumberOfLeaves(U64 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Mmr/NumberOfLeaves", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.MmrStorage.NumberOfLeavesParams());
      }
      public async Task<bool> SetNodes(H256 value, U64 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Mmr/Nodes", value.Encode(), Ajuna.SDK.Demos.NetApi.Generated.Storage.MmrStorage.NodesParams(key));
      }
   }
}
