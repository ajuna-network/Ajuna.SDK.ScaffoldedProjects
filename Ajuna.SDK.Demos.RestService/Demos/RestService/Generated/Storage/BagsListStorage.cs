...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IBagsListStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node GetListNodes(string key);
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag GetListBags(string key);
    }
    ...
    public sealed class BagsListStorage : IBagsListStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node> _listNodesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag> _listBagsTypedStorage;
        ...
        {
            this.ListNodesTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node>("BagsList.ListNodes", storageDataProvider, storageChangeDelegates);
            ...
            this.ListBagsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag>("BagsList.ListBags", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _listNodesTypedStorage property
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node> ListNodesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag> ListBagsTypedStorage
        {
            get
            {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node GetListNodes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ListNodesTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Node result))
            {
                return result;
            }
            else
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag GetListBags(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ListBagsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bags_list.list.Bag result))
            {
                return result;
            }
            else
