...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IChildBountiesStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty GetChildBounties(string key);
        
        /// <summary>
        /// >> ChildBountyDescriptions
        ///  The description of each child-bounty.
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 GetChildBountyDescriptions(string key);
    ...
    public sealed class ChildBountiesStorage : IChildBountiesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty> _childBountiesTypedStorage;
        
        /// <summary>
        /// _childBountyDescriptionsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30> _childBountyDescriptionsTypedStorage;
        ...
        public ChildBountiesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ChildBountiesTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty>("ChildBounties.ChildBounties", storageDataProvider, storageChangeDelegates);
            this.ChildBountyDescriptionsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30>("ChildBounties.ChildBountyDescriptions", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty> ChildBountiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30> ChildBountyDescriptionsTypedStorage
        {
            get
            {
        ...
        ///  Child bounties that have been added.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty GetChildBounties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ChildBountiesTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty result))
            {
                return result;
            }
            else
        ...
        ///  The description of each child-bounty.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 GetChildBountyDescriptions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ChildBountyDescriptionsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 result))
            {
                return result;
            }
            else
