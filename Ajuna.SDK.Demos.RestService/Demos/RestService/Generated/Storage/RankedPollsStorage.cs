...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IRankedPollsStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key);
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44 GetTrackQueue(string key);
    ...
    public sealed class RankedPollsStorage : IRankedPollsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> _referendumInfoForTypedStorage;
        
        /// <summary>
        /// _trackQueueTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44> _trackQueueTypedStorage;
        ...
        public RankedPollsStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ReferendumInfoForTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo>("RankedPolls.ReferendumInfoFor", storageDataProvider, storageChangeDelegates);
            this.TrackQueueTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44>("RankedPolls.TrackQueue", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoForTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferendumInfoForTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo result))
            {
                return result;
            }
            else
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT44 result))
            {
                return result;
            }
            else
