...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface ITipsStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip GetTips(string key);
    ...
    public sealed class TipsStorage : ITipsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip> _tipsTypedStorage;
        ...
        {
            this.TipsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip>("Tips.Tips", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip> TipsTypedStorage
        {
            get
            {
        ...
        ///  guaranteed to be a secure hash.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip GetTips(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TipsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_tips.OpenTip result))
            {
                return result;
            }
            else
