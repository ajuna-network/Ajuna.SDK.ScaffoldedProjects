...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IMmrStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 GetRootHash();
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 GetNodes(string key);
    }
    ...
    public sealed class MmrStorage : IMmrStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> _rootHashTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> _nodesTypedStorage;
        ...
        {
            this.RootHashTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256>("Mmr.RootHash", storageDataProvider, storageChangeDelegates);
            ...
            this.NodesTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256>("Mmr.Nodes", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _rootHashTypedStorage property
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> RootHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256> NodesTypedStorage
        {
            get
            {
        ...
        ///  Latest MMR Root hash.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 GetRootHash()
        {
        ...
        ///  are pruned and only stored in the Offchain DB.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 GetNodes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (NodesTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
