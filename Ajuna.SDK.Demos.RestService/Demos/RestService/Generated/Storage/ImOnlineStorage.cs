...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IImOnlineStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT4 GetKeys();
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque GetReceivedHeartbeats(string key);
    ...
    public sealed class ImOnlineStorage : IImOnlineStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT4> _keysTypedStorage;
        
        /// <summary>
        /// _receivedHeartbeatsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque> _receivedHeartbeatsTypedStorage;
        ...
        public ImOnlineStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.KeysTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT4>("ImOnline.Keys", storageDataProvider, storageChangeDelegates);
            this.ReceivedHeartbeatsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque>("ImOnline.ReceivedHeartbeats", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT4> KeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque> ReceivedHeartbeatsTypedStorage
        {
            get
            {
        ...
        ///  The current set of keys that may issue a heartbeat.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT4 GetKeys()
        {
        ...
        ///  `WrapperOpaque<BoundedOpaqueNetworkState>`.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque GetReceivedHeartbeats(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReceivedHeartbeatsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.frame_support.traits.misc.WrapperOpaque result))
            {
                return result;
            }
            else
