...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface IBountiesStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty GetBounties(string key);
        
        /// <summary>
        /// >> BountyDescriptions
        ///  The description of each bounty.
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 GetBountyDescriptions(string key);
        
        /// <summary>
        /// >> BountyApprovals
        ///  Bounty indices that have been approved but not yet funded.
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16 GetBountyApprovals();
    }
    ...
    public sealed class BountiesStorage : IBountiesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty> _bountiesTypedStorage;
        
        /// <summary>
        /// _bountyDescriptionsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30> _bountyDescriptionsTypedStorage;
        
        /// <summary>
        /// _bountyApprovalsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16> _bountyApprovalsTypedStorage;
        ...
        public BountiesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.BountiesTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty>("Bounties.Bounties", storageDataProvider, storageChangeDelegates);
            this.BountyDescriptionsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30>("Bounties.BountyDescriptions", storageDataProvider, storageChangeDelegates);
            this.BountyApprovalsTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16>("Bounties.BountyApprovals", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty> BountiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30> BountyDescriptionsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16> BountyApprovalsTypedStorage
        {
            get
            {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty GetBounties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BountiesTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_bounties.Bounty result))
            {
                return result;
            }
            else
        ...
        ///  The description of each bounty.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 GetBountyDescriptions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BountyDescriptionsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 result))
            {
                return result;
            }
            else
        ...
        ///  Bounty indices that have been approved but not yet funded.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16 GetBountyApprovals()
        {
