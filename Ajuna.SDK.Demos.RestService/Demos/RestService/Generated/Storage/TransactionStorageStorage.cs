...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface ITransactionStorageStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetTransactions(string key);
        ...
        /// >> BlockTransactions
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetBlockTransactions();
    ...
    public sealed class TransactionStorageStorage : ITransactionStorageStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34> _transactionsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34> _blockTransactionsTypedStorage;
        ...
        {
            this.TransactionsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34>("TransactionStorage.Transactions", storageDataProvider, storageChangeDelegates);
            ...
            this.BlockTransactionsTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34>("TransactionStorage.BlockTransactions", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34> TransactionsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34> BlockTransactionsTypedStorage
        {
            get
            {
        ...
        ///  Collection of transaction metadata by block number.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetTransactions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TransactionsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 result))
            {
                return result;
            }
            else
        ...
        /// >> BlockTransactions
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetBlockTransactions()
        {
