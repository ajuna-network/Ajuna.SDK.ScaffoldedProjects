...
namespace Ajuna.SDK.Demos.RestService.Generated.Storage
{
    ...
    public interface ILotteryStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig GetLottery();
        
        /// <summary>
        /// >> Participants
        ///  Users who have purchased a ticket. (Lottery Index, Tickets Purchased)
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> GetParticipants(string key);
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetTickets(string key);
        ...
        /// </summary>
        Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31 GetCallIndices();
    }
    ...
    public sealed class LotteryStorage : ILotteryStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig> _lotteryTypedStorage;
        
        /// <summary>
        /// _participantsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>> _participantsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32> _ticketsTypedStorage;
        
        /// <summary>
        /// _callIndicesTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> _callIndicesTypedStorage;
        ...
        public LotteryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.LotteryTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig>("Lottery.Lottery", storageDataProvider, storageChangeDelegates);
            this.ParticipantsTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>>("Lottery.Participants", storageDataProvider, storageChangeDelegates);
            ...
            this.TicketsTypedStorage = new TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32>("Lottery.Tickets", storageDataProvider, storageChangeDelegates);
            this.CallIndicesTypedStorage = new TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>("Lottery.CallIndices", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig> LotteryTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31>> ParticipantsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32> TicketsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> CallIndicesTypedStorage
        {
            get
            {
        ...
        ///  The configuration for the current lottery.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_lottery.LotteryConfig GetLottery()
        {
        ...
        ///  Users who have purchased a ticket. (Lottery Index, Tickets Purchased)
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> GetParticipants(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ParticipantsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31> result))
            {
                return result;
            }
            else
        ...
        ///  are actually valid ticket mappings.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetTickets(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TicketsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
        ...
        ///  by `Config::ValidateCall`.
        /// </summary>
        public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT31 GetCallIndices()
        {
