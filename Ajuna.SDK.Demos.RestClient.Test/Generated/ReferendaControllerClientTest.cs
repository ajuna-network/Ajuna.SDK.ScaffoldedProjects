...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class ReferendaControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT35 GetTestValue16()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT35 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT35();
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         ReferendaControllerClient rpcClient = new ReferendaControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT35 mockupValue = this.GetTestValue16();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT35 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
