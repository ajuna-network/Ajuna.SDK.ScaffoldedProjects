...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class ChildBountiesControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty GetTestValue4()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty();
         ...
         result.Status = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.EnumChildBountyStatus();
         result.Status.Create(this.GetTestValueEnum<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBountyStatus>(), this.GetTestValueBaseVoid());
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestChildBounties()
      {
         ...
         // Construct new RPC client to test with.
         ChildBountiesControllerClient rpcClient = new ChildBountiesControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty mockupValue = this.GetTestValue4();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_child_bounties.ChildBounty rpcResult = await rpcClient.GetChildBounties(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 GetTestValue7()
      {
      ...
      public async System.Threading.Tasks.Task TestChildBountyDescriptions()
      {
         ...
         // Construct new RPC client to test with.
         ChildBountiesControllerClient rpcClient = new ChildBountiesControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 mockupValue = this.GetTestValue7();
         Ajuna.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT30 rpcResult = await rpcClient.GetChildBountyDescriptions(mockupKey);
