...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class TransactionStorageControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetTestValue2()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo>();
         result.Value.Create(new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo[] {
                  this.GetTestValue3()});
         return result;
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo GetTestValue3()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo();
         result.ChunkRoot = new Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256();
         result.ChunkRoot = this.GetTestValue4();
         result.ContentHash = new Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256();
      ...
      public async System.Threading.Tasks.Task TestTransactions()
      {
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 mockupValue = this.GetTestValue2();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 rpcResult = await rpcClient.GetTransactions(mockupKey);
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 GetTestValue11()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo>();
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo GetTestValue12()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_transaction_storage.TransactionInfo();
         result.ChunkRoot = new Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256();
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 GetTestValue14()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256();
         result.Value = new Ajuna.SDK.Demos.NetApi.Generated.Types.Base.Arr32U8();
      ...
      public async System.Threading.Tasks.Task TestBlockTransactions()
      {
         ...
         // Construct new RPC client to test with.
         TransactionStorageControllerClient rpcClient = new TransactionStorageControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 mockupValue = this.GetTestValue11();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT34 rpcResult = await rpcClient.GetBlockTransactions();
