...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class AuthorshipControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT9 GetTestValue2()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT9 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT9();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.EnumUncleEntryItem>();
         result.Value.Create(new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.EnumUncleEntryItem[] {
                  this.GetTestValue3()});
         return result;
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.EnumUncleEntryItem GetTestValue3()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.EnumUncleEntryItem result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.EnumUncleEntryItem();
         result.Create(this.GetTestValueEnum<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_authorship.UncleEntryItem>(), this.GetTestValueU32());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestUncles()
      {
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT9 mockupValue = this.GetTestValue2();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT9 rpcResult = await rpcClient.GetUncles();
      ...
      public async System.Threading.Tasks.Task TestAuthor()
      {
         ...
         // Construct new RPC client to test with.
         AuthorshipControllerClient rpcClient = new AuthorshipControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 mockupValue = this.GetTestValue5();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 rpcResult = await rpcClient.GetAuthor();
