...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class GrandpaControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.EnumStoredState GetTestValue2()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.EnumStoredState result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.EnumStoredState();
         result.Create(this.GetTestValueEnum<Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredState>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestState()
      {
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.EnumStoredState mockupValue = this.GetTestValue2();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.EnumStoredState rpcResult = await rpcClient.GetState();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange GetTestValue4()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange();
         result.ScheduledAt = this.GetTestValueU32();
         result.Delay = this.GetTestValueU32();
         result.NextAuthorities = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT3();
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT3 GetTestValue5()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT3 result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT3();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>>();
         result.Value.Create(new Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>[] {
                  this.GetTestValue6()});
         return result;
      }
      public Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64> GetTestValue6()
      {
         Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64> result;
         result = new Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>();
         result.Create(this.GetTestValue7(), this.GetTestValueU64());
         return result;
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_finality_grandpa.app.Public GetTestValue7()
      {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.ed25519.Public GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestPendingChange()
      {
         ...
         // Construct new RPC client to test with.
         GrandpaControllerClient rpcClient = new GrandpaControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange mockupValue = this.GetTestValue4();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_grandpa.StoredPendingChange rpcResult = await rpcClient.GetPendingChange();
