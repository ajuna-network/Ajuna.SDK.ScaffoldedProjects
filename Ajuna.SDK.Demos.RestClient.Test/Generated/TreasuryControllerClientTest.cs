...
namespace Ajuna.SDK.Demos.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_treasury.Proposal result;
         result = new Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_treasury.Proposal();
         ...
         result.Beneficiary = new Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16 GetTestValue7()
      {
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16 mockupValue = this.GetTestValue7();
         ...
         Ajuna.SDK.Demos.NetApi.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT16 rpcResult = await rpcClient.GetApprovals();
