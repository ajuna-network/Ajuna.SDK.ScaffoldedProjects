...
namespace Ajuna.SDK.Demos.RestClient.Generated.Interfaces
{
   ...
   public interface IUniquesControllerClient
   {
      ...
      Task<U32> GetOwnershipAcceptance(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeOwnershipAcceptance(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<BaseTuple> GetAccount(BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32, U32, U32> key);
      Task<bool> SubscribeAccount(BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32, U32, U32> key);
      Task<BaseTuple> GetClassAccount(BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      Task<bool> SubscribeClassAccount(BaseTuple<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      ...
      Task<BaseTuple<U128, BaseOpt<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32>>> GetItemPriceOf(BaseTuple<U32, U32> key);
