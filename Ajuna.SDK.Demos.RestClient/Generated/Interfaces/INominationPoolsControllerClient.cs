...
namespace Ajuna.SDK.Demos.RestClient.Generated.Interfaces
{
   ...
   public interface INominationPoolsControllerClient
   {
      ...
      Task<PoolMember> GetPoolMembers(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribePoolMembers(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<U32> GetReversePoolIdLookup(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeReversePoolIdLookup(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
