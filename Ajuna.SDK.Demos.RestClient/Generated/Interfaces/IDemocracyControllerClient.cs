...
namespace Ajuna.SDK.Demos.RestClient.Generated.Interfaces
{
   ...
   public interface IDemocracyControllerClient
   {
      ...
      Task<BaseVec<BaseTuple<U32, H256, Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32>>> GetPublicProps();
      Task<bool> SubscribePublicProps();
      Task<BaseTuple<BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32>, U128>> GetDepositOf(U32 key);
      ...
      Task<EnumVoting> GetVotingOf(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeVotingOf(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<BaseTuple<U32, BaseVec<Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32>>> GetBlacklist(H256 key);
