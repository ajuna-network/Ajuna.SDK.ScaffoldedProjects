...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class IndicesControllerClient : BaseClient, IIndicesControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<AccountId32, U128, Bool>>(_httpClient, "indices/accounts", Ajuna.SDK.Demos.NetApi.Generated.Storage.IndicesStorage.AccountsParams(key));
      }
      public async Task<bool> SubscribeAccounts(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Indices.Accounts", Ajuna.SDK.Demos.NetApi.Generated.Storage.IndicesStorage.AccountsParams(key));
      }
   }
}
