...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class TreasuryControllerClient : BaseClient, ITreasuryControllerClient
   {
      ...
      {
         return await SendRequestAsync<Proposal>(_httpClient, "treasury/proposals", Ajuna.SDK.Demos.NetApi.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      public async Task<bool> SubscribeProposals(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Proposals", Ajuna.SDK.Demos.NetApi.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
