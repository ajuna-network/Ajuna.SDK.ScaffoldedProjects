...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class ReferendaControllerClient : BaseClient, IReferendaControllerClient
   {
      ...
      {
         return await SendRequestAsync<EnumReferendumInfo>(_httpClient, "referenda/referenduminfofor", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.ReferendumInfoForParams(key));
      }
      public async Task<bool> SubscribeReferendumInfoFor(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Referenda.ReferendumInfoFor", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.ReferendumInfoForParams(key));
      }
      public async Task<BoundedVecT35> GetTrackQueue(U16 key)
      {
         return await SendRequestAsync<BoundedVecT35>(_httpClient, "referenda/trackqueue", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.TrackQueueParams(key));
      }
      public async Task<bool> SubscribeTrackQueue(U16 key)
      {
         return await _subscriptionClient.SubscribeAsync("Referenda.TrackQueue", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.TrackQueueParams(key));
      }
      public async Task<U32> GetDecidingCount(U16 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "referenda/decidingcount", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.DecidingCountParams(key));
      }
      public async Task<bool> SubscribeDecidingCount(U16 key)
      {
         return await _subscriptionClient.SubscribeAsync("Referenda.DecidingCount", Ajuna.SDK.Demos.NetApi.Generated.Storage.ReferendaStorage.DecidingCountParams(key));
      }
   }
}
