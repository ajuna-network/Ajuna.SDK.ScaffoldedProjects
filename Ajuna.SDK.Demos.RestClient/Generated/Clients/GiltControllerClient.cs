...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class GiltControllerClient : BaseClient, IGiltControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT33>(_httpClient, "gilt/queues", Ajuna.SDK.Demos.NetApi.Generated.Storage.GiltStorage.QueuesParams(key));
      }
      public async Task<bool> SubscribeQueues(Ajuna.NetApi.Model.Types.Primitive.U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Gilt.Queues", Ajuna.SDK.Demos.NetApi.Generated.Storage.GiltStorage.QueuesParams(key));
      }
      ...
      {
         return await SendRequestAsync<ActiveGilt>(_httpClient, "gilt/active", Ajuna.SDK.Demos.NetApi.Generated.Storage.GiltStorage.ActiveParams(key));
      }
      public async Task<bool> SubscribeActive(Ajuna.NetApi.Model.Types.Primitive.U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Gilt.Active", Ajuna.SDK.Demos.NetApi.Generated.Storage.GiltStorage.ActiveParams(key));
      }
   }
}
