...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class StakingControllerClient : BaseClient, IStakingControllerClient
   {
      ...
      {
         return await SendRequestAsync<AccountId32>(_httpClient, "staking/bonded", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.BondedParams(key));
      }
      public async Task<bool> SubscribeBonded(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Bonded", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.BondedParams(key));
      }
      ...
      {
         return await SendRequestAsync<StakingLedger>(_httpClient, "staking/ledger", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.LedgerParams(key));
      }
      public async Task<bool> SubscribeLedger(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Ledger", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.LedgerParams(key));
      }
      public async Task<EnumRewardDestination> GetPayee(AccountId32 key)
      {
         return await SendRequestAsync<EnumRewardDestination>(_httpClient, "staking/payee", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.PayeeParams(key));
      }
      public async Task<bool> SubscribePayee(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Payee", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.PayeeParams(key));
      }
      public async Task<ValidatorPrefs> GetValidators(AccountId32 key)
      {
         return await SendRequestAsync<ValidatorPrefs>(_httpClient, "staking/validators", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ValidatorsParams(key));
      }
      public async Task<bool> SubscribeValidators(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Validators", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ValidatorsParams(key));
      }
      ...
      {
         return await SendRequestAsync<Nominations>(_httpClient, "staking/nominators", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.NominatorsParams(key));
      }
      public async Task<bool> SubscribeNominators(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Nominators", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.NominatorsParams(key));
      }
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "staking/erasstartsessionindex", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStartSessionIndexParams(key));
      }
      public async Task<bool> SubscribeErasStartSessionIndex(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasStartSessionIndex", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStartSessionIndexParams(key));
      }
      public async Task<Exposure> GetErasStakers(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<Exposure>(_httpClient, "staking/erasstakers", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStakersParams(key));
      }
      public async Task<bool> SubscribeErasStakers(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasStakers", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStakersParams(key));
      }
      public async Task<Exposure> GetErasStakersClipped(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<Exposure>(_httpClient, "staking/erasstakersclipped", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStakersClippedParams(key));
      }
      public async Task<bool> SubscribeErasStakersClipped(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasStakersClipped", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasStakersClippedParams(key));
      }
      public async Task<ValidatorPrefs> GetErasValidatorPrefs(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<ValidatorPrefs>(_httpClient, "staking/erasvalidatorprefs", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasValidatorPrefsParams(key));
      }
      public async Task<bool> SubscribeErasValidatorPrefs(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasValidatorPrefs", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasValidatorPrefsParams(key));
      }
      public async Task<U128> GetErasValidatorReward(U32 key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/erasvalidatorreward", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasValidatorRewardParams(key));
      }
      public async Task<bool> SubscribeErasValidatorReward(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasValidatorReward", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasValidatorRewardParams(key));
      }
      public async Task<EraRewardPoints> GetErasRewardPoints(U32 key)
      {
         return await SendRequestAsync<EraRewardPoints>(_httpClient, "staking/erasrewardpoints", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasRewardPointsParams(key));
      }
      public async Task<bool> SubscribeErasRewardPoints(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasRewardPoints", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasRewardPointsParams(key));
      }
      public async Task<U128> GetErasTotalStake(U32 key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/erastotalstake", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasTotalStakeParams(key));
      }
      public async Task<bool> SubscribeErasTotalStake(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasTotalStake", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ErasTotalStakeParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<UnappliedSlash>>(_httpClient, "staking/unappliedslashes", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.UnappliedSlashesParams(key));
      }
      public async Task<bool> SubscribeUnappliedSlashes(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.UnappliedSlashes", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.UnappliedSlashesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Perbill, U128>>(_httpClient, "staking/validatorslashinera", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ValidatorSlashInEraParams(key));
      }
      public async Task<bool> SubscribeValidatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ValidatorSlashInEra", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.ValidatorSlashInEraParams(key));
      }
      public async Task<U128> GetNominatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/nominatorslashinera", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.NominatorSlashInEraParams(key));
      }
      public async Task<bool> SubscribeNominatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.NominatorSlashInEra", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.NominatorSlashInEraParams(key));
      }
      public async Task<SlashingSpans> GetSlashingSpans(AccountId32 key)
      {
         return await SendRequestAsync<SlashingSpans>(_httpClient, "staking/slashingspans", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.SlashingSpansParams(key));
      }
      public async Task<bool> SubscribeSlashingSpans(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.SlashingSpans", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.SlashingSpansParams(key));
      }
      public async Task<SpanRecord> GetSpanSlash(BaseTuple<AccountId32, U32> key)
      {
         return await SendRequestAsync<SpanRecord>(_httpClient, "staking/spanslash", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.SpanSlashParams(key));
      }
      public async Task<bool> SubscribeSpanSlash(BaseTuple<AccountId32, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.SpanSlash", Ajuna.SDK.Demos.NetApi.Generated.Storage.StakingStorage.SpanSlashParams(key));
      }
