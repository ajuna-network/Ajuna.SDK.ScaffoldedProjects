...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class ElectionProviderMultiPhaseControllerClient : BaseClient, IElectionProviderMultiPhaseControllerClient
   {
      ...
      {
         return await SendRequestAsync<SignedSubmission>(_httpClient, "electionprovidermultiphase/signedsubmissionsmap", Ajuna.SDK.Demos.NetApi.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
      public async Task<bool> SubscribeSignedSubmissionsMap(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("ElectionProviderMultiPhase.SignedSubmissionsMap", Ajuna.SDK.Demos.NetApi.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
