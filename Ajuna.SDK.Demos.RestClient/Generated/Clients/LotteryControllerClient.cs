...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class LotteryControllerClient : BaseClient, ILotteryControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<U32, BoundedVecT31>>(_httpClient, "lottery/participants", Ajuna.SDK.Demos.NetApi.Generated.Storage.LotteryStorage.ParticipantsParams(key));
      }
      public async Task<bool> SubscribeParticipants(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Lottery.Participants", Ajuna.SDK.Demos.NetApi.Generated.Storage.LotteryStorage.ParticipantsParams(key));
      }
      ...
      {
         return await SendRequestAsync<AccountId32>(_httpClient, "lottery/tickets", Ajuna.SDK.Demos.NetApi.Generated.Storage.LotteryStorage.TicketsParams(key));
      }
      public async Task<bool> SubscribeTickets(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Lottery.Tickets", Ajuna.SDK.Demos.NetApi.Generated.Storage.LotteryStorage.TicketsParams(key));
      }
