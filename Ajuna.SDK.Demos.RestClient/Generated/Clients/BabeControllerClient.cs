...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class BabeControllerClient : BaseClient, IBabeControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT8>(_httpClient, "babe/underconstruction", Ajuna.SDK.Demos.NetApi.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
      public async Task<bool> SubscribeUnderConstruction(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Babe.UnderConstruction", Ajuna.SDK.Demos.NetApi.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
