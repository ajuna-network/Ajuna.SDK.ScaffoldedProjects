...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class TechnicalCommitteeControllerClient : BaseClient, ITechnicalCommitteeControllerClient
   {
      ...
      {
         return await SendRequestAsync<EnumCall>(_httpClient, "technicalcommittee/proposalof", Ajuna.SDK.Demos.NetApi.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.ProposalOf", Ajuna.SDK.Demos.NetApi.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "technicalcommittee/voting", Ajuna.SDK.Demos.NetApi.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Ajuna.SDK.Demos.NetApi.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.Voting", Ajuna.SDK.Demos.NetApi.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
