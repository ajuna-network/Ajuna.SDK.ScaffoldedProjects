...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class SocietyControllerClient : BaseClient, ISocietyControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<U128, EnumBidKind>>(_httpClient, "society/suspendedcandidates", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.SuspendedCandidatesParams(key));
      }
      public async Task<bool> SubscribeSuspendedCandidates(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.SuspendedCandidates", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.SuspendedCandidatesParams(key));
      }
      ...
      {
         return await SendRequestAsync<Bool>(_httpClient, "society/suspendedmembers", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.SuspendedMembersParams(key));
      }
      public async Task<bool> SubscribeSuspendedMembers(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.SuspendedMembers", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.SuspendedMembersParams(key));
      }
      ...
      {
         return await SendRequestAsync<EnumVouchingStatus>(_httpClient, "society/vouching", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.VouchingParams(key));
      }
      public async Task<bool> SubscribeVouching(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Vouching", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.VouchingParams(key));
      }
      public async Task<BaseVec<BaseTuple<U32, U128>>> GetPayouts(AccountId32 key)
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, U128>>>(_httpClient, "society/payouts", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.PayoutsParams(key));
      }
      public async Task<bool> SubscribePayouts(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Payouts", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.PayoutsParams(key));
      }
      public async Task<U32> GetStrikes(AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "society/strikes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.StrikesParams(key));
      }
      public async Task<bool> SubscribeStrikes(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Strikes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.StrikesParams(key));
      }
      public async Task<EnumVote> GetVotes(BaseTuple<AccountId32, AccountId32> key)
      {
         return await SendRequestAsync<EnumVote>(_httpClient, "society/votes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.VotesParams(key));
      }
      public async Task<bool> SubscribeVotes(BaseTuple<AccountId32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Votes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.VotesParams(key));
      }
      ...
      {
         return await SendRequestAsync<EnumVote>(_httpClient, "society/defendervotes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.DefenderVotesParams(key));
      }
      public async Task<bool> SubscribeDefenderVotes(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.DefenderVotes", Ajuna.SDK.Demos.NetApi.Generated.Storage.SocietyStorage.DefenderVotesParams(key));
      }
