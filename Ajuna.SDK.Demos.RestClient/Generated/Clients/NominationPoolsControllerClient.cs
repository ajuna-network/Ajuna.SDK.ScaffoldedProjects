...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class NominationPoolsControllerClient : BaseClient, INominationPoolsControllerClient
   {
      ...
      public async Task<PoolMember> GetPoolMembers(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<PoolMember>(_httpClient, "nominationpools/poolmembers", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.PoolMembersParams(key));
      }
      public async Task<bool> SubscribePoolMembers(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.PoolMembers", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.PoolMembersParams(key));
      }
      ...
      {
         return await SendRequestAsync<BondedPoolInner>(_httpClient, "nominationpools/bondedpools", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.BondedPoolsParams(key));
      }
      public async Task<bool> SubscribeBondedPools(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.BondedPools", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.BondedPoolsParams(key));
      }
      ...
      {
         return await SendRequestAsync<RewardPool>(_httpClient, "nominationpools/rewardpools", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.RewardPoolsParams(key));
      }
      public async Task<bool> SubscribeRewardPools(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.RewardPools", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.RewardPoolsParams(key));
      }
      ...
      {
         return await SendRequestAsync<SubPools>(_httpClient, "nominationpools/subpoolsstorage", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.SubPoolsStorageParams(key));
      }
      public async Task<bool> SubscribeSubPoolsStorage(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.SubPoolsStorage", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.SubPoolsStorageParams(key));
      }
      ...
      {
         return await SendRequestAsync<BoundedVecT43>(_httpClient, "nominationpools/metadata", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.MetadataParams(key));
      }
      public async Task<bool> SubscribeMetadata(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.Metadata", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.MetadataParams(key));
      }
      ...
      public async Task<U32> GetReversePoolIdLookup(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "nominationpools/reversepoolidlookup", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.ReversePoolIdLookupParams(key));
      }
      public async Task<bool> SubscribeReversePoolIdLookup(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.ReversePoolIdLookup", Ajuna.SDK.Demos.NetApi.Generated.Storage.NominationPoolsStorage.ReversePoolIdLookupParams(key));
      }
