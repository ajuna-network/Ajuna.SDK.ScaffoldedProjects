...
namespace Ajuna.SDK.Demos.RestClient.Generated.Clients
{
   ...
   public sealed class VestingControllerClient : BaseClient, IVestingControllerClient
   {
      ...
      public async Task<BoundedVecT26> GetVesting(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT26>(_httpClient, "vesting/vesting", Ajuna.SDK.Demos.NetApi.Generated.Storage.VestingStorage.VestingParams(key));
      }
      public async Task<bool> SubscribeVesting(Ajuna.SDK.Demos.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Vesting.Vesting", Ajuna.SDK.Demos.NetApi.Generated.Storage.VestingStorage.VestingParams(key));
      }
